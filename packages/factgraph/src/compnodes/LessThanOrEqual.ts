...
class LessThanOrEqualBinaryOperator<L, R>
...
const dollarDollarBinaryOperator = new LessThanOrEqualBinaryOperator(
  dollarLte
);
const rationalRationalBinaryOperator = new LessThanOrEqualBinaryOperator(
  rationalLte
);
const dayDayBinaryOperator = new LessThanOrEqualBinaryOperator(dayLte);

export class LessThanOrEqualFactory implements CompNodeFactory {
  readonly typeName = 'LessThanOrEqual';
