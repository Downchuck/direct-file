...
const intReduceOperator = createMultiplyReduceOperator(intMul);
const dollarReduceOperator = createMultiplyReduceOperator(dollarMul);
const rationalReduceOperator = createMultiplyReduceOperator(rationalMul);

function createMultiplyBinaryOperator<A, L, R>(
  op: (lhs: L, rhs: R) => A
...
const intIntBinaryOperator = createMultiplyBinaryOperator(intMul);
const dollarDollarBinaryOperator = createMultiplyBinaryOperator(dollarMul);
const rationalRationalBinaryOperator = createMultiplyBinaryOperator(rationalMul);
const dollarIntBinaryOperator = createMultiplyBinaryOperator(dollarIntMul);
const intDollarBinaryOperator = createMultiplyBinaryOperator(intDollarMul);
const rationalIntBinaryOperator = createMultiplyBinaryOperator(rationalIntMul);
const intRationalBinaryOperator = createMultiplyBinaryOperator(intRationalMul);
const dollarRationalBinaryOperator = createMultiplyBinaryOperator(
  dollarRationalMul
);
const rationalDollarBinaryOperator = createMultiplyBinaryOperator(
  rationalDollarMul
);
...
export const MultiplyFactory: CompNodeFactory = {
  typeName: 'Multiply',
  ...
  fromDerivedConfig(
    ...
    throw new Error('fromDerivedConfig not implemented for Multiply');
  },
