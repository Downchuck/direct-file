...
describe('LessThanOrEqual', () => {
    it('compares two integers and returns true', () => {
        ...
        dictionary.addDefinition({ path: '/a', derived: { typeName: 'Int', value: 2 } });
        dictionary.addDefinition({ path: '/b', derived: { typeName: 'Int', value: 5 } });
        dictionary.addDefinition({ path: '/test', derived: { typeName: 'LessThanOrEqual', children: [['/a'], ['/b']] } });
    ...
    it('compares two dollars and returns true', () => {
        const dictionary = new FactDictionary();
        dictionary.addDefinition({ path: '/a', derived: { typeName: 'Dollar', value: 2 } });
        dictionary.addDefinition({ path: '/b', derived: { typeName: 'Dollar', value: 5 } });
        dictionary.addDefinition({ path: '/test', derived: { typeName: 'LessThanOrEqual', children: [['/a'], ['/b']] } });
        const graph = new Graph(dictionary);
        expect(graph.get('/test')).toEqual(Result.complete(true));
    });
    ...
    it('compares two rationals and returns true', () => {
        ...
        dictionary.addDefinition({ path: '/b', derived: { typeName: 'Rational', value: { n: 1, d: 2 } } });
        dictionary.addDefinition({ path: '/test', derived: { typeName: 'LessThanOrEqual', children: [['/a'], ['/b']] } });
        const graph = new Graph(dictionary);
        expect(graph.get('/test')).toEqual(Result.complete(true));
    });
    ...
    it('compares two days and returns true', () => {
        const dictionary = new FactDictionary();
        dictionary.addDefinition({ path: '/a', derived: { typeName: 'Day', value: '2024-03-10' } });
        dictionary.addDefinition({ path: '/b', derived: { typeName: 'Day', value: '2024-03-15' } });
        dictionary.addDefinition({ path: '/test', derived: { typeName: 'LessThanOrEqual', children: [['/a'], ['/b']] } });
        const graph = new Graph(dictionary);
        expect(graph.get('/test')).toEqual(Result.complete(true));
    });
