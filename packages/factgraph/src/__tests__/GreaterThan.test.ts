...
describe('GreaterThan', () => {
  it('compares two integers and returns true', () => {
    ...
    dictionary.addDefinition({ path: '/test', derived: { typeName: 'GreaterThan', children: [['/a'], ['/b']] } });
  ...
  it('compares two dollars and returns true', () => {
    const dictionary = new FactDictionary();
    dictionary.addDefinition({ path: '/a', derived: { typeName: 'Dollar', value: 5 } });
  ...
  it('compares two days and returns true', () => {
    const dictionary = new FactDictionary();
    dictionary.addDefinition({ path: '/a', derived: { typeName: 'Day', value: '2024-03-15' } });
    dictionary.addDefinition({ path: '/b', derived: { typeName: 'Day', value: '2024-03-10' } });
    dictionary.addDefinition({ path: '/test', derived: { typeName: 'GreaterThan', children: [['/a'], ['/b']] } });
    const graph = new Graph(dictionary);
    expect(graph.get('/test')).toEqual(Result.complete(true));
  });
